...
(function (uitool) {
    ...
    (function (ui) {
         ...
         * @author pbk
         */
        var ComCell = /** @class */ (function () {
            function ComCell(config, parent) {
                this._config = config;
            ...
            ComCell.prototype.destroy = function () {
                if (this._comUI) {
                    this._comUI.destroy();
                    this._comUI = null;
                }
            ...
            /** 添加/修改父容器，修改层级*/
            ComCell.prototype.setParent = function (parent, layer) {
            ...
            /** 删除对象*/
            ComCell.prototype.delParent = function () {
            ...
            /** 修改属性值*/
            ComCell.prototype.setValue = function (key, value) {
            ...
            ComCell.prototype.onDragStart = function () {
                this._dragX = this.comUI.x;
                this._dragY = this.comUI.y;
            };
            ComCell.prototype.onDragEnd = function () {
            ...
            Object.defineProperty(ComCell.prototype, "comUI", {
                get: function () {
                    return this._comUI;
                },
                enumerable: true,

    ...
    (function (math) {
        ...
        var Direction8 = /** @class */ (function () {
            ...
            Object.defineProperty(Direction8.prototype, "normal", {
                ...
                get: function () {
                    switch (this.value) {
                        case Direction8.UP: return new math.Point(0, 1);
                        case Direction8.RIGHT_UP: return new math.Point(1, 1);
                        case Direction8.RIGHT: return new math.Point(1, 0);
                        case Direction8.RIGHT_DOWN: return new math.Point(1, -1);
                        case Direction8.DOWN: return new math.Point(0, -1);
                        case Direction8.LEFT_DOWN: return new math.Point(-1, -1);
                        case Direction8.LEFT: return new math.Point(-1, 0);
                        case Direction8.LEFT_UP: return new math.Point(-1, 1);
                        default: return new math.Point(0, 0);
                    }
                },
                enumerable: true,
                configurable: true
